...
const getEditCardTemplate = (data) => {
...
export default class CardEdit extends Smart {
  ...
  getTemplate() {
    return getEditCardTemplate(this._data);
  }
